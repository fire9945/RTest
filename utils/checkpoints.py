...
def get_checkpoint_paths(paths: NetPaths):
    """
    ...
    Args:
        ...
        paths: NetPaths object
    """
    weights_path = paths.latest_weights
    optim_path = paths.latest_optim
    checkpoint_path = paths.checkpoints

    return weights_path, optim_path, checkpoint_path


def save_checkpoint(paths: NetPaths, model, optimizer, *,
...
def restore_checkpoint(paths: NetPaths, model, optimizer, *,
